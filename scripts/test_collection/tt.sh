...
useproject=CESM0024
usecompset=B1850C_LTso 
useresoln=ne30pg3_t232_wg37

casename=b.e30_${cesmtag:(-8)}.${usecompset}.ne30_t232_wgx3.cmip7-testing.001
...
if [ "${do_create_newcase,,}" != "true" ]; then
     ...
     cd /glade/work/cmip7/cesm_tags/${cesmtag}/cime/scripts
     ./create_newcase --compset B1850C_LTso --res ne30pg3_t232_wg37 \
     --case /glade/u/home/cmip7/cases/${casename}  \
     --run-unsupported  --project ${useproject} --workflow cmip7
fi
...
./xmlchange PROJECT=${useproject},RESUBMIT=2,STOP_N=4,STOP_OPTION=nyears
./xmlchange REST_OPTION=nyears,REST_N=1
./xmlchange JOB_WALLCLOCK_TIME=12:00:00  --subgroup case.run
qcmd -A ${useproject} -- ./case.build
./case.submit
